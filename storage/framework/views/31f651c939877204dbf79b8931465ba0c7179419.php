            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('login')); ?>">
                        ...
                        <div class="row mb-3">
                            <label for="login" class="col-sm-4 col-form-label text-md-right"><?php echo e(__('Username / Email Address')); ?></label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\breym\mxm_proj\resources\views/auth/login.blade.php ENDPATH**/ ?>